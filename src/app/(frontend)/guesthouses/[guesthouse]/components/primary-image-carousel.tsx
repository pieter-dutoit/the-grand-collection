    ...
    >
      <CarouselContent className='-ml-2'>
        {images.map((image, index) => {
          ...
          return (
            <CarouselItem key={url + index} className='pl-2'>
              <div className='relative mb-4 mt-2 aspect-video h-fit w-full overflow-hidden rounded-lg border-2 border-gold-500 bg-olive-300 lg:rounded-2xl'>
                <Image
                  alt={alt}
                  src={url}
                  fill
