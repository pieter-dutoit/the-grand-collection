...
export default function Hero({
  ...
  return (
    <section className='relative -mt-16 overflow-hidden bg-olive-50'>
      {heroSrc && (
        <div className='relative h-[calc(40vw+4rem)] w-full sm:absolute sm:inset-y-0 sm:right-0 sm:left-[35vw] sm:aspect-auto sm:h-full'>
          <Image
            src={heroSrc}
            alt={alt}
            fill
      ...
      <div className='container mx-auto grid w-full grid-cols-1 gap-8'>
        {/* Left content */}
        <div className='z-10 flex w-full max-w-4xl flex-col gap-6 pt-8 pb-8 sm:pt-36 sm:pb-20 md:gap-10 md:pt-40 md:pb-24 lg:pt-48 lg:pb-32'>
          <div>
