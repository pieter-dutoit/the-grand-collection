...
export default function Navbar({ showFaq = true }: NavbarProps): JSX.Element {
  ...
  return (
    <nav className='sticky left-0 top-16 z-40 h-14 w-full border-b border-olive-200 bg-gradient-to-r from-olive-50/80 to-olive-50/60 backdrop-blur-lg sm:from-olive-50 sm:via-olive-50/70 sm:to-olive-50/70 lg:h-16'>
